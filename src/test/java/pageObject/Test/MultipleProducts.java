...
public class MultipleProducts {
	...
	public static void main(String[] args) {
		String[] productname = { "IPHONE 13 PRO","ZARA COAT 3", "ADIDAS ORIGINAL"};
	
		List<String> newproduct = Arrays.asList(productname);
		...
		for (WebElement product : products) {
			...
			String Element = product.findElement(By.cssSelector("b")).getText();
			if (newproduct.contains(Element)) {
...
*/
	...
	public static void loginapplication(String string, String string2) {
